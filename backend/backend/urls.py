...
urlpatterns = [
    ...
    path('customer/profile/',include(('customerProfile.urls',"customerProfile"),namespace="customerProfile")),
    path('farmer-main/',include(('farmerMain.urls',"farmerMain"),namespace="farmerMain")),
