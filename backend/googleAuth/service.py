...
def get_user_data(validated_data):
    ...
    if customer.exists():
        ...
        user = Customers.objects.create_user(is_verified=True,registration_method='google',Email = profile_data['Email'],First_name=profile_data['First_name'],Last_name = profile_data['Last_name'])
        profile_data['password'] = user.password
